;(function($, window, document, undefined){
	...
	Dragslot.prototype = {
		...
		_dragStart : function(e){
			...
			this.placeholder.css('height', dragItem.height()-10);
			...
			dragItem.css('width',dragItem.offset().width + 'px');
		...
		_dragMove : function(e){
			...
			if (this.pointEl.closest('.' + this.options.slotHandlerClass).length || this.pointEl.closest('.' + this.options.slotItemClass).length) {
                ...
                if (before) {
                    ...
                    list = this.pointEl.hasClass(this.options.slotListClass) ? this.pointEl : $(document.createElement(this.options.slotList)).addClass(this.options.slotListClass);
