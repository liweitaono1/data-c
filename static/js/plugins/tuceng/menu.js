window.onload = function () {
    ...
    var chartCanvas = document.querySelector("#chartCanvas");
    obscure.onclick = function () {
        open.style.marginLeft = "-300px";
        // console.log(1111)
        menu.setAttribute("class", "col-md-1");
          chartCanvas.setAttribute("class","chart-canvas col-md-11");
        setTimeout(function () {
    ...
    showC.onclick = function () {
        ...
        menu.setAttribute("class", "col-md-2");
        chartCanvas.setAttribute("class","chart-canvas col-md-10");
        setTimeout(function () {
